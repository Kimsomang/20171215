...
%>
<label class="btn-primary btn-lg btn-block lb_title">신고 받은 게시글 관리</label>
		...
		<table style="line-height: 10px;">
			...
			<tbody>
				...
				function reportView() {
					...
					var obj = window.open("","작품 신고", settings);
				}
				</script>
				<tr>
					...
					<th class="center">
						<form class="left" action="reportWorkDelete.do">
						...
						<form class="left" style="margin-left:5px" action="reportOK.do">
						...
						<form class="left" style="margin-left:5px" action="reportWorkBan.do">
