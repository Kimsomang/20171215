...
public class Contest {
	...
	public Contest(int contestNum, String contestTitle, String contestSponsor, String contestField,
			String contestBenefit, String dueDate, String userId, long groupNum, String contestContents,
			String contestFile, int bookmarkCount) {
		super();
